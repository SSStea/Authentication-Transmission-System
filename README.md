...
- 当前阶段：阶段 6 代码与自动化验收已完成，等待真实设备联调和提交确认
...
- `AuthenticationSenderRuntime`、`AuthenticationReceiverRuntime`：阶段6可停止线程、绝对时间调度、有界接收和文本认证；
